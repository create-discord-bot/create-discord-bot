...
console.clear();
console.log(chalk.blue.bold("create-discord_bot"));
const defaultNames = [
    "awesome-bot",
    "wicked-bot",
    "a-nice-bot",
    ...
    .then(async (answers) => {
        ...
        try {
            ...
            await downloadTemplate(
                `github:flzyy/create-discord_bot/templates/${answers.language}`,
                {
            ...
            if (answers.eslint === true) {
                ...
                await downloadTemplate(
                    `github:flzyy/create-discord_bot/templates/eslint/${answers.language}`,
                    {
                        dir: answers.directoryPath,
                        force: true
                    }
            ...
            if (answers.prettier === true) {
                ...
                await downloadTemplate(
                    `github:flzyy/create-discord_bot/templates/prettier`,
                    {
                        dir: answers.directoryPath,
                        force: true
                    }
